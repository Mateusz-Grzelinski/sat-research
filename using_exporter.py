...
if __name__ == '__main__':
    ...
    exporter = TPTPExporter(
        output_dir='./temp-out',
        filename_handle=lambda formula_info: f'clauses_{formula_info.number_of_instances[CNFClause]}_'
                                             f'atoms_{formula_info.number_of_instances[Atom]}_'
                                             f'predicates_{formula_info.number_of_instances[Predicate]}_'
                                             f'functors_{formula_info.number_of_instances[Functor]}_'
                                             f'vars_{formula_info.number_of_instances[Variable]}_'
    )
